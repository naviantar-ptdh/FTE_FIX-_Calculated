    ...
    if compute_clicked:
        try:
            ...
            st.session_state.calc1_result = compute_fte(
                ...
                backend,
                # Hasilnya dibaca sebagai jumlah ORANG: kebutuhan 0,70 orang
                # tetap berarti harus menyiapkan 1 orang, jadi total tiap role
                # dibulatkan KE ATAS (lihat aggregate_units).
                round_mode="ceil",
            )
